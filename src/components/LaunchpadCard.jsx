...
const LaunchpadCard = ({
  ...
  return (
    <Link to={link}>
      <div
        className="launchpad-card overflow-hidden relative hover:scale-95 h-auto"
      >
        {BlockchainLogo}
        ...
        <div className='p-4 sm:p-[20px] relative'>
          ...
          <div className="launchpad-progress-container">
            <div className="launchpad-progress-text">Progress&#x20;<span className='text-[#00f3ef]'>({Number(progress).toLocaleString()}%)</span></div>
