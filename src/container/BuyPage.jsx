...
const App = () => {
  ...
  const BASE_URL = 'https://dogdefi.fun/buy/?chain=' + chainId + '&address=' + ChadAddress
                            ...
                            <div className="flex flex-col relative items-end">
                              ...
                              <div className="flex gap-2 items-center">
                                <span className="text-[#919191] text-[12px] font-semibold flex gap-1">
                                  ...
                                  <div className='cursor-pointer text-[#f3cc2f]' onClick={setMaxAmount}>Max</div>
