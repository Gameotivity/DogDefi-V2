...
import { imageUrl, apiUrl, imageUploadUrl, ethPriceApiUrl, supportedChainIds, chainLogos, scanLinks, coinNames } from '../utils/constants.ts'
...
const Profile = () => {
  ...
  const [userName, setUserName] = useState('@DogDefing')
